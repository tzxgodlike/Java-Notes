...
public class DigitsInSequence_44 {
    ...
    /**
     * 数字以0123456789101112131415....的格式序列化得到一个字符序列中，在这个序列中，第5位（从0开始计数）是5，
     * 第13位是1，第19位是4，等等。
     * 请写一个函数，求任意第n位对应的数字
     */
    ...
    方法1： 逐个列举
     */
    public static int numAtSeq(int index) {
        if (index<0)  return -1;
        ...
        System.out.println(sum+" "+index+" "+i);
    ...
    public static int numAtSeq2(int index) {
        if (index < 0) return -1;
     ...
     * ...
     */
    private static int numOfRange(int n) {
        if (n == 1) return 10;
     ...
     */
    private static int beginNumber(int n) {
        if (n == 1) return 0;
        return (int) Math.pow(10, n - 1);
    }

    private static int digitAt2(int seqIndex, int digits) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(numAtSeq(1001));
        System.out.println(numAtSeq2(1001));
    }
}
